...
<div class='container'>
    <div class='col-lg-8 col-lg-offset-2 block join-form-block'>
        ...
        <form id="children-form" class='form-inline queue-form' role='form' >
            ...
            <input type="text" name="children-count" value="0" id="children-count" style="display: none;" />
            ...
            <div class='form-group form-group-list'>
                ...
                <div class='row'>
                    <label class='checkbox-inline'>
                        <input name = 'kindergarten' type='checkbox' id='kindergarten-checkbox' value='true'> Детский сад/Ясли
                    </label>
                    <label class='checkbox-inline'>
...
<div class="container">
    <div class="col-lg-8 col-lg-offset-2">
        <div class="col-lg-offset-4 col-lg-4">
            <a class="btn btn-primary" href="/success" style="width:100%;">Дальше</a>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#others-form").submit(function (e) {
            ...
            var m_data = "district=" + $("#select-district").change().val()+
                    ...
                    "&kindergarten=" + $("#kindergarten-checkbox").prop("checked") +
    ...
    function addChild() {
        $(document).ready(function () {
            ...
            var child = "<div class='row child'>" +
                "<div class='form-group form-group-list'>" +
                "<input type='text' class='form-control child-surname' id='surname-child-input-"+ count +"' name='child-surname-"+ count +"' placeholder='Фамилия'>" +
                "</div>" +
                "<div class='form-group form-group-list'>" +
                "<input type='text' class='form-control child-name' id='name-child-input-"+ count +"' name='child-name-"+ count +"' placeholder='Имя'>" +
                "</div>" +
                "<div class='form-group form-group-list'>" +
                "<input type='text' class='form-control child-patronym' id='patronymic-child-input-"+ count +"' name='child-patronym-"+ count +"' placeholder='Отчество'>" +
                "</div>" +
                "<button class='btn btn-primary' type='button' value='-' onclick=\"removeCh(this)\"><span class='glyphicon glyphicon-minus'></button>" +
                "</div>";
            if ($(".child").is(":last")) {
